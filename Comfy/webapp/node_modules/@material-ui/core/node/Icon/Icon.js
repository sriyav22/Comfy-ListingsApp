...
const Icon = /*#__PURE__*/React.forwardRef(function Icon(props, ref) {
  ...
  return /*#__PURE__*/React.createElement(Component, (0, _extends2.default)({
    ...
    'notranslate', classes.root, className, color !== 'inherit' && classes[`color${(0, _capitalize.default)(color)}`], fontSize !== 'default' && classes[`fontSize${(0, _capitalize.default)(fontSize)}`]),
    "aria-hidden": true,
    ref: ref
  }, other));
});
